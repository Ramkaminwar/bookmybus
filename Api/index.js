...
app.post("/Booke_ticket", function (req, res) {
  ...
  try {
    ...
    <body>
        ...
        <h1 class="con">Ticket Confirmation</h1>
        <hr>
        
        <h2 class="con">Dear ${req.body.user_name},</h2>
        
        <p class="con">Dear ${req.body.user_name},
        ...
        <div class="cont">
        <img src="https://raw.githubusercontent.com/Ramkaminwar/bookmybus/main/tkt.png" alt="background" class="mail_bg">
      <table class="cont2">
